function d_Ref_Pert=simNetworkEBSkipSpkShort(epsiMat, tauMat, initVoltages, tSpikes, tBegin, tEnd, dt, dataMode, T, gamma_i, I_i, tol_eq, osc_types, osc_skip)
...
%% Raster plot
d_Ref_Pert=sqrt(sum((pert_V(end,:)-ref_V).^2));
end
